...
class TriageSchema(Schema):
    ...
    ehr_extracted_symptoms = fields.List(fields.Str(), allow_none=True)
    ehr_extracted_vitals = fields.Dict(allow_none=True)
    ehr_processing_note = fields.Str(allow_none=True)
